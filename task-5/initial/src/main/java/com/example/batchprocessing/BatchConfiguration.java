	...
	public JdbcBatchItemWriter<Product> writer(DataSource dataSource) {
		return new JdbcBatchItemWriterBuilder<Product>()
			.sql("INSERT INTO products (productId, productSku, productName, productAmount, productData) " +
					...
					"ON CONFLICT (productId) DO UPDATE SET productSku = EXCLUDED.productSku, productName = EXCLUDED.productName, productAmount = EXCLUDED.productAmount, productData = EXCLUDED.productData")
